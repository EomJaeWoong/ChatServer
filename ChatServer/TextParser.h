...
public :
	...
	bool		GetValue(char *pField, char *ipValue)
	{
		char *chpBuf, chBuf[eMAX_FIELD_LENGTH];
		int iLength;
	...
	bool		GetValue(char *pField, unsigned char *ipValue)
	{
		char *chpBuf, chBuf[eMAX_FIELD_LENGTH];
		int iLength;
	...
	// 값을 얻기
	////////////////////////////////////////////////////////////////////////
	bool		GetValue(char *pField, unsigned long *ipValue)
	{
		char *chpBuf, chBuf[eMAX_FIELD_LENGTH];
		int iLength;
	...
	bool		GetValue(char *pField, WCHAR *pValue, int *ipBufSize)
	{
		char *chpBuf, chBuf[eMAX_FIELD_LENGTH];
		int iLength;
				...
				if (GetNextWord(&chpBuf, &iLength))
				{
					...
					if (0 == strcmp(chBuf, "="))
					{
						if (GetNextWord(&chpBuf, &iLength))
						{
							...
							memset(pValue, 0, iLength);
							MultiByteToWideChar(CP_ACP, 0, chpBuf, iLength, pValue, iLength);
